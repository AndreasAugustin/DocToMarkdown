//  *************************************************************
// <copyright file="ReturnsMarkdownNodeParserTest.cs" company="None">
...
namespace DocToMarkdown.Tests
{
    ...
    /// <summary>
    /// Test for the <see cref="ReturnsMarkdownNodeParser"/> class.
    /// </summary>
    [TestFixture]
    public class ReturnsMarkdownNodeParserTest
    {
        #region fields

        private const String NodeString = "<returns>Returns zero.</returns>";
        ...
        public void Init_CreateObject_IsNotNull()
        {
            ...
            var obj = new ReturnsMarkdownNodeParser(parserPoolStub, environmentStub);
        ...
        public void Parse_ParseInputElement_ResultEqualsExpected()
        {
            ...
            var parser = new ReturnsMarkdownNodeParser(parserPoolStub, environmentMock);

            var result = parser.ParseToMarkdown(input);

            var expected = String.Format("{1}> **Returns**: {0}{1}{1}", "Returns zero.", environmentMock.NewLine);
