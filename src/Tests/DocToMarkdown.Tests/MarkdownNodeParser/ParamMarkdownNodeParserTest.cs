//  *************************************************************
// <copyright file="ParamMarkdownNodeParserTest.cs" company="None">
...
namespace DocToMarkdown.Tests
{
    ...
    public class ParamMarkdownNodeParserTest
    {
        ...
        private const String NodeString = "<param name=\"Int1\">Used to indicate status.</param>";
        ...
        public void Init_CreateObject_IsNotNull()
        {
            ...
            var obj = new ParamMarkdownNodeParser(parserPoolStub, environmentStub);
        ...
        public void Parse_ParseInputElement_ResultEqualsExpected()
        {
            ...
            var parser = new ParamMarkdownNodeParser(parserPoolStub, environmentMock);
